...
public actor NativeNVSTStreamingPath {
    ...
    private func startStreaming(configuration: PreparedLaunchConfiguration,
        ...
        do {
            ...
            if error as? NativeNVSTError == .sessionLimitReached {
                ...
                throw StreamSessionError.activeSessionConflict(StreamSessionConflict(
    ...
    private func recover(session: StreamSessionDescriptor, configuration: PreparedLaunchConfiguration) async -> Bool {
