...
@objc(GFNError)
public final class GFNError: NSObject {
    ...
    public static func userFacingMessage(errorMessage: String, gameTitle: String) -> String {
        GFNErrorMapper.userFacingMessage(errorMessage, gameTitle: gameTitle)
    }
    ...
    public static func userFacingMessage(errorMessage: String, gameTitle: String, sessionWasConnected: Bool) -> String {
        GFNErrorMapper.userFacingMessage(errorMessage, gameTitle: gameTitle, sessionWasConnected: sessionWasConnected)
    }
}
