...
const installedHelper = "/usr/local/libexec/pixelnow-remote-coop-pam-auth-helper";
const defaultExplicitGroup = "pixelnow-coop-admin";
...
function helperPath() {
  const configured = environmentValue("PIXELNOW_REMOTE_COOP_PANEL_AUTH_HELPER");
...
function allowedGroups() {
  const configured = environmentValue("PIXELNOW_REMOTE_COOP_PANEL_ALLOWED_GROUPS");
