...
struct VendorResourceImage: View {
    ...
    private static func loadImage(name: String, fileExtension: String) -> NSImage? {
        ...
        for subdirectory in ["PixelNOW", "Resources/PixelNOW", "NVIDIA", "Resources/NVIDIA", nil] as [String?] {
...
struct AccountAvatar: View {
    ...
    var body: some View {
        Text(initials)
            ...
            .background(Color.pixelNowGreen, in: RoundedRectangle(cornerRadius: size * 0.32, style: .continuous))
    }
}
