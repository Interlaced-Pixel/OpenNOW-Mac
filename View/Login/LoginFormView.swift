...
struct LoginFormView: View {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                if !viewModel.validationMessage.isEmpty || !viewModel.successMessage.isEmpty {
                    Text(viewModel.validationMessage.isEmpty ? viewModel.successMessage : viewModel.validationMessage)
                        ...
                        .foregroundStyle(viewModel.validationMessage.isEmpty ? Color.pixelNowGreen : .orange)
                        .lineSpacing(2)
    ...
    private func rememberedAccountRow(_ account: LoginAccount) -> some View {
        ...
        .overlay {
            Rectangle().stroke(isLastActive ? Color.pixelNowGreen.opacity(0.55) : Color.gfnStroke, lineWidth: 1)
        }
    }
